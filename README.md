...
Nótese que como el programa es compatible con ambos sensores, SCD30 y MHZ14A, **hay que instalar todas las librerías enumeradas**, incluso en el caso de que se planee utilizar un único tipo de sensor.
