...
- [*Anaire PiCO2*](https://github.com/anaireorg/anaire-devices/blob/main/Anaire.PiCO2/README.md)
Nuestro último modelo, basado en el sensor de alta gama [*Sensirion SCD30*](https://www.sensirion.com/en/environmental-sensors/carbon-dioxide-sensors/carbon-dioxide-sensors-scd30/), con precición de 30 PPM (partes por millón), alarma acústica, pantalla a color y batería recargable mediante USB-C, lo que permite su uso portátil.
- [*Anaire 30/50ppm*](https://github.com/anaireorg/anaire-devices/blob/main/Anaire.30ppm-50ppm/README.md)
Nuestro primer dispositivo, con dos opciones: **Anaire 30ppm**, también basado en el mismo sensor [*Sensirion SCD30*](https://www.sensirion.com/en/environmental-sensors/carbon-dioxide-sensors/carbon-dioxide-sensors-scd30/), y **Anaire 50ppm**, que equipa el sensor [*Winsen MHZ14A*](https://www.winsen-sensor.com/sensors/co2-sensor/mh-z14a.html), de menor coste pero también menor precisión (50 PPM) y mayor tiempo de respuesta. Ambos modelos con alarma acústica, pantalla monocroma y alimentación mediante MicroUSB.
...
* [El País:_ Un salón, un bar y una clase: así contagia el coronavirus en el aire](https://elpais.com/ciencia/2020-10-24/un-salon-un-bar-y-una-clase-asi-contagia-el-coronavirus-en-el-aire.html)
